...
export const appRoutes: Route[] = [
    ...
    ,
    {
        ...
        children: [
            { path: 'notifications', loadChildren: () => import('app/modules/notifications/notifications.module').then(x => x.NotificationsModule) },
            { path: 'profile', loadChildren: () => import('app/modules/profile/profile.module').then(m => m.ProfileModule) },
            { path: 'feed', loadChildren: () => import('app/modules/home/home.module').then(m => m.HomeModule) },
            { path: 'post', loadChildren: () => import('app/modules/post/post.module').then(m => m.PostModule) },
            { path: 'people', loadChildren: () => import('app/modules/people/people.module').then(m => m.PeopleModule) },
            { path: 'blocked-user', loadChildren: () => import('app/modules/blocked-user/blocked-user.module').then(m => m.BlockedUserModule) },
        ]
    },
    {
        path: '',
